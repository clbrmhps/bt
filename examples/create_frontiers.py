...
def process_date(current_date, er, covar, rdf, frontiers_dir, plots_dir):
    ...
    # Your existing code for processing each date goes here
    # Make sure to replace global variable references with function arguments as needed
    # At the end, return any results you need from this function

    # This is a simplified example; you would include your detailed processing logic here
    print(f"Processing date: {current_date}")
    # Assume some processing here and return results
...
# Your existing setup code to prepare `dates`, `er`, `covar`, `rdf`, etc.

# Example call to parallelize the loop
if __name__ == "__main__":
    ...
    with ProcessPoolExecutor() as executor:
        # Using a list comprehension to submit all jobs and gather results
