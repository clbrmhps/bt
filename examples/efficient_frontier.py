...
weight_caaf = pd.read_csv(f'data/security_weights/Security_Weights_CurrentCAAF_{version_number}.csv', index_col=0)
weight_twostage = pd.read_csv(f'data/security_weights/Security_Weights_TwoStage_{version_number}.csv', index_col=0)
properties_caaf = pd.read_csv(f'data/portfolio_properties/Properties_CurrentCAAF_{version_number}.csv', index_col=0)
properties_twostage = pd.read_csv(f'data/portfolio_properties/Properties_TwoStage_{version_number}.csv', index_col=0)
